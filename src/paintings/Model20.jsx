...
export function Model20(props) {
  ...
  const { nodes, materials } = useGLTF("/Model20.glb");
  ...
  return (
    <group ref={myMesh} {...props} dispose={null} scale={2} position={[-0.5,1,0]}>
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.brush_Splatter_g0_b0.geometry}
        material={materials.brush_Splatter}
       ><meshBasicMaterial  color={"#ACF200"}   map={brushSplatterMap}  transparent={true} depthWrite={false} /></mesh>
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.brush_LightWire_g0_b0.geometry}
        material={materials.brush_LightWire}
      />
      <mesh
        castShadow
        receiveShadow
       ...
       ><meshBasicMaterial  color={"purple"}   map={brushSplatterMap}  transparent={true}  depthWrite={false}/></mesh>
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.brush_WigglyGraphite_g0_b0.geometry}
        material={materials.brush_WigglyGraphite}
       ><meshPhongMaterial  emissive={"blue"}  color={"blue"} emissiveIntensity={4}  map={brushWigglyGraphiteMap}  transparent={true} depthWrite={false} /></mesh>
    </group>
  );
}

useGLTF.preload("/Model20.glb");