...
export function Model23(props) {
  ...
  const { nodes, materials } = useGLTF("/Model23.glb");
  ...
  return (
    <group ref={myMesh} {...props} dispose={null} scale={2} position={[0,1,0]}>
      <mesh
       ...
       ><meshPhongMaterial    emissive={"green"}   color={"green"}    emissiveIntensity={5} map={brushDiamondHullMap}  transparent={true}   depthWrite={false}/></mesh>
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.brush_DiamondHull_g0_b0.geometry}
        material={materials.brush_DiamondHull}
       ><meshPhongMaterial    emissive={"#FFEEC5"}   color={"#FFEEC5"}   opacity={0.1} emissiveIntensity={2} map={brushDiamondHullMap}  transparent={true}   depthWrite={false}/></mesh>
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
       ...
       ><meshPhongMaterial    emissive={"#FFEEC5"}   color={"#FFEEC5"}   opacity={0.1} emissiveIntensity={2} map={brushDiscoMap}  transparent={true}   depthWrite={false}/></mesh>
      {/* <mesh
        castShadow
        receiveShadow
        geometry={nodes.brush_Streamers_g0_b0.geometry}
        material={materials.brush_Streamers}
      ><meshPhongMaterial    emissive={"#FFEEC5"}   color={"#FFEEC5"}   opacity={0.1} emissiveIntensity={2} map={brushStreamersMap}  transparent={true}   depthWrite={false}/></mesh>
      <mesh
        castShadow
        receiveShadow
