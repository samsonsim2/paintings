  ...
  return (
    <group ref={myMesh} {...props} dispose={null} scale={2} position={[0,1,0]}>
      {/* <mesh
        ...
        ><meshBasicMaterial map={brushStreamersMap} color={"red"}/></mesh>
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
       ...
       ><meshPhongMaterial map={brushSoftHiglighterMap}  emissive={"#C000FF"}  emissiveIntensity={1} color={"#C000FF"}  transparent={true} opacity={0.7}/></mesh>
      {/* <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        ><meshBasicMaterial map={brushThickPaintMap}  color={"grey"}  transparent={true} opacity={0.7}/></mesh>
      <mesh
        castShadow
        receiveShadow
