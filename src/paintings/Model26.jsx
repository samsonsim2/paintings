  ...
  return (
    <group ref={myMesh} {...props} dispose={null} scale={2} position={[0,1,0]}>
      ...
      <mesh
       ...
       ><meshPhongMaterial    emissive={"white"}   color={"white"}   emissiveIntensity={2}    transparent={true}   depthWrite={false}/></mesh>
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.brush_Fire_g0_b0.geometry}
        material={materials.brush_Fire}
       ><meshPhongMaterial    emissive={"#DF00FF"}   color={"#DF00FF"}   emissiveIntensity={1} map={brushFireMap}  transparent={true}   depthWrite={false}/></mesh>
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.brush_DiamondHull_g0_b0.geometry}
        material={materials.brush_DiamondHull}
       ><meshPhongMaterial    emissive={"green"}   color={"green"}   emissiveIntensity={2} map={brushDiamondHullMap}  transparent={true}   depthWrite={false}/></mesh>
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.brush_WigglyGraphite_g0_b0.geometry}
        material={materials.brush_WigglyGraphite}
       ><meshPhongMaterial     emissive={"#2C7000"}   color={"#2C7000"}    emissiveIntensity={2} map={brushWigglyGraphiteMap}  transparent={true}   depthWrite={false}/></mesh>
      {/* <mesh
        castShadow
        receiveShadow
